...
public class RowApp2 extends LinearLayout {
    ...
    public RowApp2(Context context) {
        this(context,null);
        Log.d("wwww","asdfasdfdddd444");

    }

    public RowApp2(Context context, AttributeSet attrs) {
        this(context,attrs,0);
        Log.d("wwww","asdfasdfdddd333");

    }

    public RowApp2(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context,attrs,0,0);
        Log.d("wwww","asdfasdfdddd");

    }

    public RowApp2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        LayoutInflater.from(context).inflate(R.layout.row_app_app, this);
